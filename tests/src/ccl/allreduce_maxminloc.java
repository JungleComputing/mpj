...
class allreduce_maxminloc {
    static public void test() throws MPJException {
        ...
        // int //////////////////////////////////////////
        if (world_rank == 0)
            System.out.println("Testing MPJ.MAXLOC with MPJ.INT2...");
        ...
        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.INT2 and op MPJ.MAXLOC (" + fnderr
                    + " of " + count + " wrong)");

        // long //////////////////////////////////////////
        if (world_rank == 0)
            System.out.println("Testing MPJ.MAXLOC with MPJ.LONG2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_l, 0, out_l, 0, count, MPJ.LONG2,
                MPJ.MAXLOC);
        ...
        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.LONG2 and op MPJ.MAXLOC (" + fnderr
                    + " of " + count + " wrong)");

        // short //////////////////////////////////////////
        MPJ.COMM_WORLD.barrier();
        if (world_rank == 0)
            System.out.println("Testing MPJ.MAXLOC with MPJ.SHORT2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_s, 0, out_s, 0, count, MPJ.SHORT2,
                MPJ.MAXLOC);
        ...
        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.SHORT2 and op MPJ.MAXLOC (" + fnderr
                    + " of " + count + " wrong)");

        // float //////////////////////////////////////////
        MPJ.COMM_WORLD.barrier();
        if (world_rank == 0)
            System.out.println("Testing MPJ.MAXLOC with MPJ.FLOAT2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_f, 0, out_f, 0, count, MPJ.FLOAT2,
                MPJ.MAXLOC);
        ...
        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.FLOAT and op MPJ.MAXLOC (" + fnderr
                    + " of " + count + " wrong)");

        // double //////////////////////////////////////////
        MPJ.COMM_WORLD.barrier();
        if (world_rank == 0)
            System.out.println("Testing MPJ.MAXLOC with MPJ.DOUBLE2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_d, 0, out_d, 0, count, MPJ.DOUBLE2,
                MPJ.MAXLOC);
        ...
        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.DOUBLE and op MPJ.MAXLOC (" + fnderr
                    + " of " + count + " wrong)");
        ...
        // int //////////////////////////////////////////
        if (world_rank == 0)
            System.out.println("Testing MPJ.MINLOC with MPJ.INT2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_mn_i, 0, out_mn_i, 0, count, MPJ.INT2,
                MPJ.MINLOC);
        ...
        for (i = 0; i < count; i++) {
            if (out_mn_i[i * 2] != sol_mn_i[i * 2]
                ...
                System.out.println(world_rank + " Expected (" + sol_mn_i[i * 2]
                        + "," + sol_mn_i[i * 2 + 1] + ") got ("
                        + out_mn_i[i * 2] + "," + out_mn_i[i * 2 + 1] + ")");
            }
        }

        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.INT2 and op MPJ.MINLOC (" + fnderr
                    + " of " + count + " wrong)");

        // long //////////////////////////////////////////
        if (world_rank == 0)
            System.out.println("Testing MPJ.MINLOC with MPJ.LONG2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_mn_l, 0, out_mn_l, 0, count, MPJ.LONG2,
                MPJ.MINLOC);
        ...
        // short //////////////////////////////////////////
        if (world_rank == 0)
            System.out.println("Testing MPJ.MINLOC with MPJ.SHORT2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_mn_s, 0, out_mn_s, 0, count, MPJ.SHORT2,
                MPJ.MINLOC);
        ...
        for (i = 0; i < count; i++) {
            if (out_mn_s[i * 2] != sol_mn_s[i * 2]
                ...
                System.out.println(world_rank + " Expected (" + sol_mn_s[i * 2]
                        + "," + sol_mn_s[i * 2 + 1] + ") got ("
                        + out_mn_s[i * 2] + "," + out_mn_s[i * 2 + 1] + ")");
            }
        }

        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.SHORT2 and op MPJ.MINLOC (" + fnderr
                    + " of " + count + " wrong)");

        // double //////////////////////////////////////////
        if (world_rank == 0)
            System.out.println("Testing MPJ.MINLOC with MPJ.DOUBLE2...");
        ...
        MPJ.COMM_WORLD.allreduce(in_mn_d, 0, out_mn_d, 0, count, MPJ.DOUBLE2,
                MPJ.MINLOC);
        ...
        for (i = 0; i < count; i++) {
            if (out_mn_d[i * 2] != sol_mn_d[i * 2]
                ...
                System.out.println(world_rank + " Expected (" + sol_mn_d[i * 2]
                        + "," + sol_mn_d[i * 2 + 1] + ") got ("
                        + out_mn_d[i * 2] + "," + out_mn_d[i * 2 + 1] + ")");
            }
        }

        if (fnderr > 0)
            System.out.println(world_rank
                    + " Error for type MPJ.DOUBLE2 and op MPJ.MINLOC ("
                    + fnderr + " of " + count + " wrong)");
