...
Ibis MPJ is part of Ibis, an open source Java grid software project of
...
Ibis MPJ is a Java-only implementation of MPJ, built on the Ibis Portability
Layer (IPL), which is included in this release.
Some example Ibis MPJ applications are provided in the "examples" directory.

Ibis MPJ is free software. See the file "LICENSE.txt" for copying permissions.

The users's guide in the docs directory ("docs/usersguide.pdf") explains
how to compile and run your Ibis MPJ application.

The javadoc of Ibis MPJ is available in "javadoc/index.html".

Ibis has its own web-site: http://www.cs.vu.nl/ibis/.  There, you can
find more Ibis documentation, papers, application sources.

The latest Ibis MPJ source repository tree is accessible through SVN at
"https://gforge.cs.vu.nl/svn/ibis/mpj/trunk".  You can check it
out anonymously using the command
"svn checkout https://gforge.cs.vu.nl/svn/ibis/mpj/trunk mpj".

The file BUGS.txt contains information for filing bug reports.

** Third party libraries included with Ibis MPJ **
