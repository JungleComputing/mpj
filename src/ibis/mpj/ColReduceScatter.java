...
public class ColReduceScatter {
    ...
    public ColReduceScatter(Object sendbuf, int sendoffset, Object recvbuf,
    ...
    protected void call() throws MPJException {
        ...
        this.comm.reduce(sendbuf, sendoffset, sendbuf, sendoffset, count,
                datatype, op, 0);
        this.comm.scatterv(sendbuf, sendoffset, recvcounts, displs, datatype,
                recvbuf, recvoffset, recvcounts[this.comm.rank()], datatype, 0);
    }
