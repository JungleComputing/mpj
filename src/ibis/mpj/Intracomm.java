...
public class Intracomm extends Comm {
     ...
     * 
     * @param group
     *            group to be associated with the new communicator
    ...
    /**
     * Broadcast a message from the process with rank root to all processes of
     * the group.
     * 
     * @param sendbuf
     *            buffer array
     ...
     * @throws MPJException
     */
    public void bcast(Object sendbuf, int offset, int count, Datatype datatype,
            int root) throws MPJException {

        ColBcast bcast = new ColBcast(sendbuf, offset, count, datatype, root,
                this, TAG_BCAST);
    ...
    public void gather(Object sendbuf, int sendoffset, int sendcount,
        ...
        ColGather gather = new ColGather(sendbuf, sendoffset, sendcount,
                sendtype, recvbuf, recvoffset, recvcount, recvtype, root, this,
                TAG_GATHER);
    ...
    /**
     * Extends funcionality of gather by allowing varying counts of data from
     * each process. The sizes of arrays recvcount and displs should be the size
     * of the group. Entry i of displs specifies the displacement relative to
     * element recvoffset of recvbuf at which to place incoming data. Note that
     * if recvtype is a derived datatype, elements of displs are in units of the
     * derived type extent, (unlike recvoffset, which is a direct index into the
     * buffer array).
     * 
     * @param sendbuf
     *            send buffer array
    ...
    public void gatherv(Object sendbuf, int sendoffset, int sendcount,
            Datatype sendtype, Object recvbuf, int recvoffset, int[] recvcount,
            int[] displs, Datatype recvtype, int root) throws MPJException {

        ColGatherV gatherv = new ColGatherV(sendbuf, sendoffset, sendcount,
                sendtype, recvbuf, recvoffset, recvcount, displs, recvtype,
                root, this, TAG_GATHERV);
    ...
    public void scatter(Object sendbuf, int sendoffset, int sendcount,
        ...
        ColScatter scatter = new ColScatter(sendbuf, sendoffset, sendcount,
                sendtype, recvbuf, recvoffset, recvcount, recvtype, root, this,
                TAG_SCATTER);
     ...
     *            number of items sent to each process
     * @param displs
     *            displacements from which to take outgoing data
     * @param sendtype
     *            datatype of each item in send buffer
     * @param recvbuf
     *            receive buffer array
    ...
    public void scatterv(Object sendbuf, int sendoffset, int[] sendcount,
            ...
            int recvcount, Datatype recvtype, int root) throws MPJException {

        ColScatterV scatterv = new ColScatterV(sendbuf, sendoffset, sendcount,
                displs, sendtype, recvbuf, recvoffset, recvcount, recvtype,
                root, this, TAG_SCATTERV);
        scatterv.call();
    ...
    public void allgather(Object sendbuf, int sendoffset, int sendcount,
        ...
        ColAllGather allGather = new ColAllGather(sendbuf, sendoffset,
     ...
     *            initial offset in receive buffer
     * @param recvcount
     *            numver of elements received from each process
     * @param displs
     *            displacements at which to place incoming data
     * @param recvtype
     *            datatype of each item in receive buffer
    ...
    public void allgatherv(Object sendbuf, int sendoffset, int sendcount,
            Datatype sendtype, Object recvbuf, int recvoffset, int[] recvcount,
            int[] displs, Datatype recvtype) throws MPJException {

        ColAllGatherV allGatherV = new ColAllGatherV(sendbuf, sendoffset,
                sendcount, sendtype, recvbuf, recvoffset, recvcount, displs,
                recvtype, this, TAG_GATHERV);
        allGatherV.call();
    }

    /**
     * Extension to allgather to the case where each process sends distinct data
     ...
     *            initial offset in receive buffer
     * @param recvcount
     *            number of items received fram any process
     * @param recvtype
     *            datatype of receive buffer items
     * @throws MPJException
     */
    public void alltoall(Object sendbuf, int sendoffset, int sendcount,
        ...
        ColAllToAll allToAll = new ColAllToAll(sendbuf, sendoffset, sendcount,
                sendtype, recvbuf, recvoffset, recvcount, recvtype, this,
                TAG_ALLTOALL);
    ...
    /**
     * Adds felxibility to alltoall: location of data for send is specified by
     * sdispls and location to place the data on receive side is specified by
     * rdispls.
     * 
     * @param sendbuf
     *            send buffer array
    ...
    public void alltoallv(Object sendbuf, int sendoffset, int[] sendcount,
            ...
            throws MPJException {
        ColAllToAllV allToAllV = new ColAllToAllV(sendbuf, sendoffset,
                sendcount, sdispls, sendtype, recvbuf, recvoffset, recvcount,
                rdispls, recvtype, this, TAG_ALLTOALLV);
    ...
    public void reduce(Object sendBuf, int sendOffset, Object recvBuf,
        ...
        ColReduce reduce = new ColReduce(sendBuf, sendOffset, recvBuf,
                recvOffset, count, datatype, op, root, this, TAG_REDUCE);
        reduce.call();

    }

    /**
     * Same as reduce except that the result appears in receive buffer of all
    ...
    public void allreduce(Object sendbuf, int sendoffset, Object recvbuf,
        ...
        ColAllreduce allreduce = new ColAllreduce(sendbuf, sendoffset, recvbuf,
                recvoffset, count, datatype, op, this, TAG_ALLREDUCE_1);
        allreduce.call();

        /*
         * ColReduce reduce = new ColReduce(sendbuf, sendoffset, recvbuf,
         * recvoffset, count, datatype, op, 0, this, this.TAG_ALLREDUCE_1);
         * reduce.execute();
         * 
         * 
         * ColBcast bcast = new ColBcast(recvbuf, recvoffset, count, datatype,
         * 0, this, this.TAG_ALLREDUCE_2); bcast.execute();
         */
    ...
    /**
     * Combine elements in input buffer of each process using the reduce
     * operation, and scatter the combined values vover the output buffers of
     * the processes.
     * 
     * @param sendbuf
     *            send buffer array
     ...
     *            initial offset in receive buffer
     * @param recvcounts
     *            number of result elements distributed to each process
     * @param datatype
     *            datatype of each item in send buffer
     * @param op
     *            reduce operation
     * @throws MPJException
     */
    public void reduceScatter(Object sendbuf, int sendoffset, Object recvbuf,
            int recvoffset, int[] recvcounts, Datatype datatype, Op op)
            throws MPJException {

        ColReduceScatter reduceScatter = new ColReduceScatter(sendbuf,
                sendoffset, recvbuf, recvoffset, recvcounts, datatype, op,
                this, TAG_REDUCESCATTER);
    ...
    public void scan(Object sendbuf, int sendoffset, Object recvbuf,
        ...
        ColScan scan = new ColScan(sendbuf, sendoffset, recvbuf, recvoffset,
                count, datatype, op, this, TAG_SCAN);
     ...
     * of this communicator. The number of nodes in the graph, nnodes, is taken
     ...
     *            graph edges
     * @param reorder
     *            true if ranking my be reordered, false if not
     * @return new graph topology communicator
     * @throws MPJException
     */
    public Graphcomm createGraph(int[] index, int[] edges, boolean reorder)
            throws MPJException {
        return (null);
    }
     ...
     * group of this communicator. The number of dimensions of the Cartesian
     * grid is taken to be the size of the dims argument. The array periods must
     * be the same size.
     * 
     * @param dims
     *            the number of processes in each dimension
     * @param periods
     *            true if grid is periodic, false if not, in each dimension
     * @param reorder
     *            true if ranking may be reordered, false if not
     * @return new Cartesian topology communicator
     * @throws MPJException
     */
    public Cartcomm createCart(int[] dims, boolean[] periods, boolean reorder)
            throws MPJException {
        return (null);
    }
