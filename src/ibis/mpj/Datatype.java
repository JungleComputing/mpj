...
public class Datatype implements Serializable {
        ...
        if (count > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                for (int j = 0; j < this.size() - 1; j++) {
                    contDatatype.displacements[displIndex] = nextItem
                            + this.displacements[j];
                    displIndex++;
                }
            }
        }
    ...
    /**
     * <strong> NOT IMPLEMENTED YET. </strong> Construct new datatype
     * representing replication of old datatype into locations that consist of
    ...
    /**
     * <strong> NOT IMPLEMENTED YET. </strong> Identical to vector except that
     * the stride is expressed directly in terms of the buffer index, rather
     * than the units of the old type.
     * 
     * @param count
     *            number of blocks
     * @param blocklength
    ...
    /**
     * <strong> NOT IMPLEMENTED YET. </strong> Construct new datatype
     * representing replication of old datatype into a sequence of blocks where
     * each block can contain a different number of copies and have a different
     * displacement.
     * 
     * @param arrayofBlocklengths
     *            number of elements per block
     * @param arrayofDisplacements
    ...
    /**
     * <strong> NOT IMPLEMENTED YET. </strong> Identical to indexed except that
     * the displacements are expressed directly in terms of the buffer index,
     * rather than the units of the old type.
     * 
     * @param arrayofBlocklengths
     *            number of elements per block
     * @param arrayofDisplacements
    ...
    /**
     * <strong> NOT IMPLEMENTED YET. </strong> The most general type
     * constructor.
     * 
     * @param arrayofBlocklengths
     *            number of elements per block
    ...
    public static Datatype struct(int[] arrayofBlocklengths,
            int[] arrayofDisplacements, Datatype[] arrayOfTypes)
            throws MPJException {
    ...
    /**
     * Find the upper bound of a datatype - the greatest value in its
    ...
    /**
     * <strong> NOT IMPLEMENTED YET. </strong> Commit a derived datatype.
     * 
     * @throws MPJException
     */
