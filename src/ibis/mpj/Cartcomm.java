...
public class Cartcomm extends Intracomm {
     ...
     * Number of dimensions ist the size of dims. Note that dims is an inout
     * parameter.
     * 
     * @param nnodes
     *            number of nodes in a grid
     * @param dims
     *            array of Cartesian dimensions
     * @throws MPJException
     */
     ...
     * <strong> NOT IMPLEMENTED YET. </strong>
     * 
     * Returns Cartesian topology information. The number of dimensions can be
     * obtained from the size of (eg) the dims array.
     * 
     ...
     * 
     * @param remainDims
     *            by dimension, true if dimension is to be kept, false otherwise
     ...
     * <strong> NOT IMPLEMENTED YET. </strong>
     * 
     * Comput an optimal placement. The number of dimensions is taken to be size
     * of the dims argument.
     * 
     * @param dims
