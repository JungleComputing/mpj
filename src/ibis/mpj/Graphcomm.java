...
public class Graphcomm extends Intracomm {
     ...
     * 
     * Returns graph topology information. The number of nodes and number of
     * edges can be extracted from sizes of the index and edges arrays.
     * 
     ...
     * <strong> NOT IMPLEMENTED YET. </strong>
     * 
     * Provides adjcency information for general graph topology. The number of
     * neighbours can be extracted from the size of the result.
     * 
     * @param rank
     ...
     * <strong> NOT IMPLEMENTED YET. </strong>
     * 
     * Comput an optimal placement. The number of nodes is taken to be size of
     * the index argument.
     * 
     * @param index
     *            node degrees
