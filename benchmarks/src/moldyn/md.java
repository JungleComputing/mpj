...
public class md {
    ...
    public void runiters() throws MPJException {
        ...
        for (move = 0; move < movemx; move++) {
            ...
            MPJ.COMM_WORLD.allreduce(tmp_xforce, 0, tmp_xforce, 0, mdsize,
                    MPJ.DOUBLE, MPJ.SUM);
            MPJ.COMM_WORLD.allreduce(tmp_yforce, 0, tmp_yforce, 0, mdsize,
                    MPJ.DOUBLE, MPJ.SUM);
            MPJ.COMM_WORLD.allreduce(tmp_zforce, 0, tmp_zforce, 0, mdsize,
                    MPJ.DOUBLE, MPJ.SUM);
            ...
            MPJ.COMM_WORLD.allreduce(tmp_epot, 0, tmp_epot, 0, 1, MPJ.DOUBLE,
                    MPJ.SUM);
            MPJ.COMM_WORLD.allreduce(tmp_vir, 0, tmp_vir, 0, 1, MPJ.DOUBLE,
                    MPJ.SUM);
            MPJ.COMM_WORLD.allreduce(tmp_interactions, 0, tmp_interactions, 0,
                    1, MPJ.INT, MPJ.SUM);
