...
public class ReturnPath extends PathId {
    ...
    /**
     * Method to calculate <code>volatility</code> and
     * <code>volatility2</code> from the return path data, using the
     * relationship, based on the precomputed <code>variance</code>. \sigma^2 =
     * s^2\Delta t
     * 
     * @exception DemoException
     ...
     * 
     * @exception DemoException
     *                thrown if the <code>mean</code> or
