...
public class JGFRayTracerBench extends RayTracer implements JGFSection3 {
    ...
    public JGFRayTracerBench(int nprocess, int rank) {
        JGFRayTracerBench.nprocess = nprocess;
        JGFRayTracerBench.rank = rank;
    }
    ...
    public void JGFvalidate() {
        ...
        // of 2000
        /*
         * long refval[] = {2676692,29827635}; long dev = checksum -
         * refval[size]; if (dev != 0 ){ System.out.println("Validation
         * failed"); System.out.println("Pixel checksum = " + checksum);
    ...
    public void JGFrun(int size) throws MPJException {
        ...
        if (rank == 0) {
            JGFInstrumentor.addTimer("Section3:RayTracer:Total", "Solutions",
                    size);
            JGFInstrumentor
                    .addTimer("Section3:RayTracer:Init", "Objects", size);
        ...
        if (rank == 0) {
            ...
            JGFInstrumentor.addOpsToTimer("Section3:RayTracer:Init",
                    (double) numobjects);
            JGFInstrumentor.addOpsToTimer("Section3:RayTracer:Run",
                    (double) (width * height));
