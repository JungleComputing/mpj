...
void Do() throws MPJException
{
    ...
    if(JGFSeriesBench.rank==0) {
      ...
      for(int k=1;k<JGFSeriesBench.nprocess;k++) {
        ...
        MPJ.COMM_WORLD.recv(p_TestArray[0],0,p_TestArray[0].length,MPJ.DOUBLE,k,k);
        MPJ.COMM_WORLD.recv(p_TestArray[1],0,p_TestArray[1].length,MPJ.DOUBLE,k,
      ...
      MPJ.COMM_WORLD.ssend(p_TestArray[0],0,p_TestArray[0].length,MPJ.DOUBLE,0,JGFSeriesBench.rank);
      MPJ.COMM_WORLD.ssend(p_TestArray[1],0,p_TestArray[1].length,MPJ.DOUBLE,0,
      JGFSeriesBench.rank+JGFSeriesBench.nprocess);
    } 
