    ...
    public void JGFrun() throws MPJException {
        ...
        for (l = 0; l < MLOOPSIZE; l++) {
            ...
            while (time[0] < TARGETTIME && size < MAXSIZE) {
                ...
                if (rank == 0) {
                    ...
                    time[0] = JGFInstrumentor
                            .readTimer("Section1:Bcast:Double");
                    JGFInstrumentor.addOpsToTimer("Section1:Bcast:Double",
            ...
            if (rank == 0) {
                ...
                JGFInstrumentor
                        .addTimeToTimer("Section1:Bcast:Double", -b_time);
                JGFInstrumentor.printperfTimer("Section1:Bcast:Double",
                        arr.length);
            }
        ...
        for (l = 0; l < MLOOPSIZE; l++) {
            ...
            while (time[0] < TARGETTIME && size < MAXSIZE) {
                ...
                /* Carryout the broadcast operation */
                for (int k = 0; k < size; k++) {
                    MPJ.COMM_WORLD.bcast(arr_obj, 0, arr_obj.length,
                            MPJ.OBJECT, 0);
                    MPJ.COMM_WORLD.barrier();
                ...
                if (rank == 0) {
                    ...
                    time[0] = JGFInstrumentor
                            .readTimer("Section1:Bcast:Object");
                    JGFInstrumentor.addOpsToTimer("Section1:Bcast:Object",
            ...
            if (rank == 0) {
                ...
                b_time = JGFInstrumentor.readTimer("Section1:Bcast:Barrier");
                JGFInstrumentor
                        .addTimeToTimer("Section1:Bcast:Object", -b_time);
                JGFInstrumentor.printperfTimer("Section1:Bcast:Object",
                        arr_obj.length);
            }
