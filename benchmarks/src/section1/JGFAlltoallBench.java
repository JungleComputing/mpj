    ...
    public void JGFrun() throws MPJException {
        ...
        for (l = 0; l < MLOOPSIZE; l++) {
            ...
            while (time[0] < TARGETTIME && size < MAXSIZE) {
                ...
                for (int k = 0; k < size; k++) {
                    MPJ.COMM_WORLD.alltoall(send_arr, 0, m_size, MPJ.DOUBLE,
                            recv_arr, 0, m_size, MPJ.DOUBLE);
                    MPJ.COMM_WORLD.barrier();
                ...
                if (rank == 0) {
                    ...
                    time[0] = JGFInstrumentor
                            .readTimer("Section1:Alltoall:Double");
                    JGFInstrumentor.addOpsToTimer("Section1:Alltoall:Double",
                            (double) size * m_size * 8);
                }
            ...
            if (rank == 0) {
                ...
                JGFInstrumentor.addTimeToTimer("Section1:Alltoall:Double",
                        -b_time);
                JGFInstrumentor.printperfTimer("Section1:Alltoall:Double",
                        m_size);
            }
        ...
        for (l = 0; l < MLOOPSIZE; l++) {
            ...
            while (time[0] < TARGETTIME && size < MAXSIZE) {
                ...
                /* Carryout the broadcast operation */
                for (int k = 0; k < size; k++) {
                    MPJ.COMM_WORLD.alltoall(send_arr_obj, 0, m_size,
                            MPJ.OBJECT, recv_arr_obj, 0, m_size, MPJ.OBJECT);
                    MPJ.COMM_WORLD.barrier();
                ...
                if (rank == 0) {
                    ...
                    time[0] = JGFInstrumentor
                            .readTimer("Section1:Alltoall:Object");
                    JGFInstrumentor.addOpsToTimer("Section1:Alltoall:Object",
                            (double) size * m_size);
            ...
            if (rank == 0) {
                JGFInstrumentor.stopTimer("Section1:Alltoall:Barrier");
                b_time = JGFInstrumentor.readTimer("Section1:Alltoall:Barrier");
                JGFInstrumentor.addTimeToTimer("Section1:Alltoall:Object",
                        -b_time);
                JGFInstrumentor.printperfTimer("Section1:Alltoall:Object",
                        m_size);
            }
