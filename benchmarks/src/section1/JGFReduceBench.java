        ...
        for (l = 0; l < MLOOPSIZE; l++) {
            ...
            while (time[0] < TARGETTIME && size < MAXSIZE) {
                ...
                for (int k = 0; k < size; k++) {
                    MPJ.COMM_WORLD.reduce(send_arr, 0, recv_arr, 0,
                            send_arr.length, MPJ.DOUBLE, MPJ.SUM, 0);
                    MPJ.COMM_WORLD.barrier();
                ...
                if (rank == 0) {
                    ...
                    time[0] = JGFInstrumentor
                            .readTimer("Section1:Reduce:Double");
                    JGFInstrumentor.addOpsToTimer("Section1:Reduce:Double",
            ...
            if (rank == 0) {
                ...
                JGFInstrumentor.addTimeToTimer("Section1:Reduce:Double",
                        -b_time);
                JGFInstrumentor.printperfTimer("Section1:Reduce:Double",
                        send_arr.length);
            }
