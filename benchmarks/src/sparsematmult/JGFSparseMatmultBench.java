...
*/
  ...
  if(rank==0) {
    ...
    for(int k=1;k<nprocess;k++) {
      ...
      MPJ.COMM_WORLD.ssend(buf_row,(k*ref_p_datasizes_nz),p_datasizes_nz,MPJ.INT,k,1);
      MPJ.COMM_WORLD.ssend(buf_col,(k*ref_p_datasizes_nz),p_datasizes_nz,MPJ.INT,k,2);
      MPJ.COMM_WORLD.ssend(buf_val,(k*ref_p_datasizes_nz),p_datasizes_nz,MPJ.DOUBLE,k,3);
    }
